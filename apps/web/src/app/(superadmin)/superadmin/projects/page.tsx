...
export default async function SuperadminProjectsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-foreground">{t("superadmin.page.projectsTitle")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("superadmin.page.projectsSubtitle")}</p>
      </div>
