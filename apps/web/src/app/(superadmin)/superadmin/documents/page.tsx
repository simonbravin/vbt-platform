...
export default async function SuperadminDocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">{t("superadmin.page.documentsTitle")}</h1>
        <p className="mt-1 text-sm text-gray-500">{t("superadmin.page.documentsSubtitle")}</p>
      </div>
