...
const patchSchema = z.object({
  pricing: z
    .object({
      ...
      containerWallAreaM2S80: z.number().min(1).nullable().optional(),
      containerWallAreaM2S150: z.number().min(1).nullable().optional(),
      containerWallAreaM2S200: z.number().min(1).nullable().optional(),
      containerCapacityM3: z.number().min(1).nullable().optional(),
